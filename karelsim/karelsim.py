...
class TkView(object):
    ...
    def _load_images(self):
        self._karel_images = [tk.PhotoImage(file="images/karel-n.gif"),
                              tk.PhotoImage(file="images/karel-e.gif"),
                              tk.PhotoImage(file="images/karel-w.gif"),
                              tk.PhotoImage(file="images/karel-s.gif")]
        self._beeper_image = tk.PhotoImage(file="images/beeper.gif")
